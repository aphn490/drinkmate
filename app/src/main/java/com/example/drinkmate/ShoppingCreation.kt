...
class ShoppingCreation : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val currentCart = view.findViewById<TextView>(R.id.textView20)
        val cartName = view.findViewById<EditText>(R.id.cartName)
        ...
        saveButton.setOnClickListener() {
            if (cartName.text.toString() != "") {
                ...
                Toast.makeText(requireContext(), "Please Input a Shopping Cart Name.", Toast.LENGTH_SHORT).show()
            }
        }
    }
}